...
<<<<<<< HEAD
        camera.set(new Point3D(10, 10, 10), new Point3D(0, 0, 0), new Vec3d(0,1,0));
=======
        camera.set(new Point3D(-10, 10, 20), new Point3D(0, 0, 0), new Vec3d(0,1,0));
>>>>>>> parent of 29d3ea9... SHadow
...
<<<<<<< HEAD
        //Object objects[] = {new Cube(-5,-10,-6,1,Color.GREEN),new Cube(1.5,0,0,1,Color.ORANGE),new Sphere(3,3,3,1,Color.cyan),new Sphere(0,2,0,3,Color.ORANGE)};
        ...
        Object objects[] = {new Cube(0,0,0,100,Color.GREEN),new Sphere(3,3,4,1,Color.MAGENTA)};

        Light light = new Light(20,20,20);
=======
        Object objects[] = {new Cube(0,2,0,1,Color.GREEN),new Cube(1.5,0,0,1,Color.ORANGE),new Sphere(3,3,3,1,Color.cyan),new Sphere(3,3,-3,1,Color.ORANGE),new Floor(-3,0,0,-1,Color.RED)};
        //Object objects[] = {new Cube(0,0,0,1,Color.GREEN),new Floor(0,0,0,-1,Color.RED)};
        //Object objects[] = {new Sphere(0,5,0,1,Color.cyan),new Floor(0,0,0,-1,Color.RED)};
        ...
        for(int i=0;i<sizex;i++) {
            for (int j = 0; j < sizey; j++) {
                ...
                for (int obj = 0; obj < objects.length; obj++) {
                    ...
                    if(hit.getIsHit()){
                        hit.InverTranslateRay(objects[hitobject].scalingMatrix,objects[hitobject].translationMatrix);
                        hit.calcHitDist(ray);
